...
# Command line arguments for running the script.  For explanation, see
...
# Run first for CentOs/Fedora/Redhat
# sudo sh -c 'yum-check update; yum install wget -y;' &> /dev/null

# Run first for MacOS
# sh -c 'brew update --force; brew install wget --with-libressl'
