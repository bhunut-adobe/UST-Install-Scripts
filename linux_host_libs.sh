...
# includes Ubuntu, CentOS, Fedora, and MacOS. Each implementation is named something like load[Hostname]Resources, and the
...
function hostInterfaceDefinition(){
    ...
    # 2.2.2 and 2.3rc4.  When 2.3 releases, the logic default UST version will be 2.3.
...
function loadUbuntuResources(){
    ...
    function verifyHostVersion(){
        ...
        # Version specific case - TSL 1.2 ssl is no loner available in Ubuntu 13, despite numerous efforts by the author to
        # track this dependency down.  Since github requires this for downloading files, the user is warned that the script will
    ...
    # Adding python 3.5 to Ubuntu - requres deadsnakes external repository in some cases
    # (this is a catch-all)
...
function loadMacOsResources(){
    ...
    if [[ $ustVer == "2.3" ]]; then
        # UST Version 2.3rc4 Links
        USTExamplesURL="https://github.com/adobe-apiplatform/user-sync.py/releases/download/v2.3rc4/example-configurations.tar.gz"
        USTPython2URL="https://github.com/adobe-apiplatform/user-sync.py/releases/download/v2.3rc4/user-sync-2.3rc4-macosx-py2714.tar.gz"
        USTPython3URL="https://github.com/adobe-apiplatform/user-sync.py/releases/download/v2.3rc4/user-sync-2.3rc4-macosx-py364.tar.gz"
    else
        # UST Version 2.2.2 Links
        USTExamplesURL="https://github.com/adobe-apiplatform/user-sync.py/releases/download/v2.2.1/example-configurations.tar.gz"
